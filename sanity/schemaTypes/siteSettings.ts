...
export const siteSettingsType = defineType({
  ...
  fields: [
    ...
    defineField({name: 'philosophyPillars', title: 'Philosophy pillars', type: 'array', group: 'practice', of: [defineArrayMember({type: 'object', fields: [defineField({name: 'title', title: 'Title', type: 'string'}), defineField({name: 'description', title: 'Description', type: 'text', rows: 3}), defineField({name: 'image', title: 'Image', type: 'image', options: {hotspot: true}})]})]}),
    defineField({name: 'practice', title: 'Practice description', type: 'array', group: 'practice', of: [defineArrayMember({type: 'block'})]}),
    defineField({name: 'founders', title: 'Founders', type: 'array', group: 'practice', of: [defineArrayMember({type: 'object', fields: [defineField({name: 'name', title: 'Name', type: 'string'}), defineField({name: 'role', title: 'Role', type: 'string'}), defineField({name: 'image', title: 'Portrait', type: 'image', options: {hotspot: true}})]})]}),
    defineField({name: 'craftImage', title: 'Craft photograph', type: 'image', group: 'practice', options: {hotspot: true}}),
    ...['services', 'publications'].map((name) => defineField({name, title: name === 'services' ? 'Services' : 'Publications', type: 'array', group: 'practice', of: [defineArrayMember({type: 'object', fields: [defineField({name: 'title', type: 'string'}), defineField({name: 'description', type: 'text'}), defineField({name: 'image', type: 'image', options: {hotspot: true}})]})]})),
